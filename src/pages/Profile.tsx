...
import { updateUserProfile, updateUserPassword, getUserProfile, type UserProfile } from '../lib/api/users';
          ...
          <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-6">
            <div className="flex flex-col items-center space-y-4">
              <div className="relative">
                ...
                <label
                  htmlFor="photo"
                  className="absolute bottom-0 right-0 bg-locimo-blue rounded-full p-2 cursor-pointer hover:bg-blue-900"
                >
